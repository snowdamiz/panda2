...
var catalog = []Feature{
	...
	},
	{
		...
		Description:      "Panda role profiles, channel rules, role tool access, and budget limits.",
		PandaPermissions: []string{admin.PermissionAdminConfigRead, admin.PermissionAdminConfigWrite},
		ToolNames:        []string{"panda.manage_role_permission", "panda.manage_channel_rule", "panda.manage_tool_access", "panda.manage_budget_limit"},
		Public:           true,
