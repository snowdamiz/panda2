...
func permissionBits(names []string) disgoDiscord.Permissions {
	...
	for _, name := range names {
		...
		case "EMBED_LINKS":
			permissions = permissions.Add(disgoDiscord.PermissionEmbedLinks)
		case "ATTACH_FILES":
			permissions = permissions.Add(disgoDiscord.PermissionAttachFiles)
		case "READ_MESSAGE_HISTORY":
			permissions = permissions.Add(disgoDiscord.PermissionReadMessageHistory)
		case "CONNECT":
			permissions = permissions.Add(disgoDiscord.PermissionConnect)
		case "SPEAK":
			permissions = permissions.Add(disgoDiscord.PermissionSpeak)
		case "USE_VAD":
			permissions = permissions.Add(disgoDiscord.PermissionUseVAD)
		case "MANAGE_ROLES":
		...
		case "SEND_POLLS":
			permissions = permissions.Add(disgoDiscord.PermissionSendPolls)
		case "PIN_MESSAGES":
