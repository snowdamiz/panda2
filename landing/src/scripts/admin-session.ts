...
export const messageForError = (message: string): string => {
  const messages: Record<string, string> = {
    ...
    unknown_pack: 'Choose a paid pack.',
    ...
    invalid_period_end: 'Use YYYY-MM-DD or RFC3339 for the pack expiry date.',
    ...
    credit_account_update_failed: 'The credit account change was rejected.',
